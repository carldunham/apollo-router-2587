...
type QueryResolver interface {
	Animal(ctx context.Context) (model.Animal, error)
...
var sources = []*ast.Source{
	{Name: "../../schema/animal.graphqls", Input: `schema {
  query: Query
}
...
func (ec *executionContext) _Query_animal(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAnimal2mainᚋgraphᚋmodelᚐAnimal(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖmainᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAnimal2mainᚋgraphᚋmodelᚐAnimal(ctx context.Context, sel ast.SelectionSet, v model.Animal) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNDog2mainᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚖmainᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
